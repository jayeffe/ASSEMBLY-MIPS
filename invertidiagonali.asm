#invertire gli elementi della diagonale principale con quella secondaria 
...
duepunti:.asciiz ":"
accapo:.asciiz " \n "
stampas:.asciiz " la matrice invertendo le diagonali  e' la seguente "
...
jr $ra
		...
		li $t0,0
			ciclo_interno:
			beq $t0,2,esci_ciclointerno
				addi $t8,$t8,8
				li $t1,0
				ciclo_esterno:
				beq $t1,1,esci_cicloesterno
				lw $t2,($t9)
				lw $t3,($t8)
