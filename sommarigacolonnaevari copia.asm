...
sommacolonna:
	...
	ciclo_colonna3:
		#nel registro $t7 metto la somma delle colonne
		li $t7, 0#lo azzero per fare la somma
		move $t8, $t9 #uso $t8 per muovermi sulle colonne e l'ho incremento di 12 
		beq $t0, 3, fine_somma_colonne
		li $t1,0 #contatore colonne 
		ciclo_righe3:
			beq $t1,3,fine_ciclo_righe3
